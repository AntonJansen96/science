    ...
    def __read_pdb(self, fname):
        ...
        for idx in range(0, len(atomLines)):
            ...
            if currentResID != nextResID or lastLine:
                ...
                residues.append(
                    Residue(atoms, currentResName, currentChain, currentResID, x, y, z)
                )
    ...
    def __read_gro(self, fname):
        ...
        for idx in range(0, len(atomLines)):
            ...
            if idx == len(atomLines) - 1:
                self.d_box = Crystal(
                    10 * float(atomLines[idx][0:10]),
                    10 * float(atomLines[idx][10:20]),
                    10 * float(atomLines[idx][20:30]),
                    90,
                    90,
                    90,
                    "P 1",
            ...
            if currentResID != nextResID or idx == len(atomLines) - 2:
                ...
                # Create the Residue object.
                residues.append(
                    Residue(atoms, currentResName, " ", currentResID, x, y, z)
                )
    ...
    def __write_gro(self, fname):
        ...
        with open(fname, "w") as file:
            ...
            if hasattr(self, "d_box"):
                ...
                file.write(
                    "{:>10.5f}{:>10.5f}{:>10.5f}\n".format(
                        cryst.d_a / 10, cryst.d_b / 10, cryst.d_c / 10
                    )
                )
            else:
